...
This repository exists to **improve model safety** by studying failure modes in a controlled environment.

- **Do not** pursue or share instructions for wrongdoing.
- **Do not** attack systems without permission.
- **Do** keep tests to local/synthetic targets.
- **Do** practice responsible disclosure when appropriate.

**Maintainers:** PRs and issues are welcome—please open a discussion for significant changes before submitting a patch.